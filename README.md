...
`assets.json` now records the resolved commit. Commit it alongside your code, and anyone who clones your repo can run `git skill install` and get the exact same trees back.
